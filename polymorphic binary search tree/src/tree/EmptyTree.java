 ...
 */
 public class EmptyTree<K extends Comparable<K>,V> implements Tree<K,V> 
 {
	...
	{
		return new NonEmptyTree(key, value, getInstance(), getInstance());
	}
	...
	{
		 return this.subTreeAux(fromKey, toKey, this);
	}
	
	public Tree<K,V> subTreeAux(K fromKey, K toKey, Tree<K,V> subTree) 
	{
		return this;
	}
